...
5. **Source pipeline:** Are there sources in `superpaper/sources/` (including meetings, bookmarks) without corresponding evidence/claim notes in `superpaper/concepts/`? Flag unprocessed sources.
