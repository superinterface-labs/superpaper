...
1. Create a note in the appropriate entity folder (`superpaper/concepts/`, `superpaper/people/`, `superpaper/questions/`, `superpaper/events/`, `superpaper/meta/`, etc.) using the knowledge note template. Route self-knowledge and alignment insights to `meta/`.
