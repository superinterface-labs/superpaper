...
3. Tell the agent: *"Read AGENTS.md and set up the vault."*
4. Start talking and following instructions to set it up.
...
7. Obsidian is also available on most platforms, so you can keep track of your notes and (eventually) the agents in the same place.
